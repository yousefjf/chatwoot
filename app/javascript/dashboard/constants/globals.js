export default {
  ...
  DOCS_URL: 'https://goftina.com/docs/product/',
  HELP_CENTER_DOCS_URL:
    'https://goftina.com/docs/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.goftina.com/content.json',
